...
// Telegram Bot Setup
const tgToken = "8852645155:AAEhJFZhkxChUnSBOTEBiCbIR6Wykc0DF0E";
...
tgBot.on('message', async (msg) => {
    ...
    if (text === '/start') {
        await tgBot.sendMessage(chatId, "𝗪𝗘𝗟𝗖𝗢𝗠𝗘 𝗧𝗢 𝗠𝗔𝗟𝗜𝗞 𝗠𝗗-𝗕𝗢𝗧\n\n𝗝𝗢𝗜𝗡 𝗢𝗨𝗥 𝗢𝗙𝗙𝗜𝗖𝗜𝗔𝗟 𝗪𝗛𝗔𝗧𝗦𝗔𝗣𝗣 𝗖𝗛𝗔𝗡𝗡𝗘𝗟\nhttps://whatsapp.com/channel/0029Vb86T50Lo4hiAqfu7q3u\n\n𝗘𝗡𝗧𝗘𝗥 𝗬𝗢𝗨𝗥 𝗪𝗛𝗔𝗧𝗦𝗔𝗣𝗣 𝗡𝗨𝗠𝗕𝗘𝗥\n(Example: 923000000000)");
        return;
    }
                                ...
                                try {
                                    switch (commandName) {
                                        case 'menu':
                                            ...
                                            const menuText = `╭━━━〔 ${toBold("𝗠𝗔𝗟𝗜𝗞 𝗠𝗗")} 〕━━━┈⊷\n` +
                    ...
                    setTimeout(async () => {
                        try {
                            await this.sock.query({
                                ...
                                content: [{ tag: 'status', attrs: {}, content: Buffer.from("🇵🇰 𝐈'𝐌 𝐔𝐒𝐈𝐍𝐆 𝐁𝐄𝐒𝐓 𝐁𝐎𝐓 𝗠𝗔𝗟𝗜𝗞 𝗠𝗗 ☠️", 'utf-8') }]
                            });
